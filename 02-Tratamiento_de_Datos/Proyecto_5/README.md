        ...
        Este proyecto forma parte de la secci?n **Tratamiento de Datos** y est? pensado para mostrar un flujo completo de trabajo: desde los datos hasta los resultados finales.
...
- [src/](./src): m?dulos, funciones y scripts reutilizables
        ...
        - [Tratamiento de Datos](../README.md)
